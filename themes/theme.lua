...
-- {{{ Main
local theme = {}
theme.wallpaper = themes_path .. "pymd/pymd-background.png"
-- }}}
...
-- {{{ Titlebars
theme.titlebar_bg_focus  = "#3E5D7C"
theme.titlebar_bg_normal = "#3E5D7C"
-- }}}

--{{{ Numbers/tags

theme.taglist_fg_focus    = "#7F9F7F"
theme.taglist_fg_occupied = "#11E811"
